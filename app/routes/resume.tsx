...
const resume = () => {
    ...
    const [resumeUrl, setResumeRul] = useState('');
        ...
        <main className="!pt-0">
            ...
            <div className="flex flex-row w-full max-lg:flex-col-reverse">
                <section className="feedback-section bg-[url('/images/bg-small.svg) bg-cover h-[100vh] sticky top-0 item-center justify-center'">
                    ...
                    {imageUrl && resumeUrl && (
                        <div className="animate-in fade-in duration-1000 gradient-border mx-sm:m-0h-[90%] max-2xl:h-fit w-fit">
